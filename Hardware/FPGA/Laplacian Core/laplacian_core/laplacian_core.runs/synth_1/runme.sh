...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/Laplacian Core/laplacian_core/laplacian_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpc_top.tcl
