...
--        ext_video_data_in => ext_video_data,
--        ext_video_clk_in => clk_297m,
--        ext_video_hsync_in => ext_video_hsync_in,
--        ext_video_vsync_in => ext_video_vsync_in,
--        ext_video_de_in => ext_video_de_in,

--        int_video_data_in => s_video_data,
--        int_video_clk_in => clk_297m,
...
--    );
    video_data <= ext_video_data;
    video_pixel_clk <= clk_297m;
    video_hs <= ext_video_hsync_in;
    video_vs <= ext_video_vsync_in;
    video_de <= ext_video_de_in;
