...
HD_PWD='C:/Users/micha/OneDrive/Desktop/DICE/Hardware/FPGA/FT600 Loopback/Project/FT600_Loopback.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mst_fifo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mst_fifo_top.tcl -notrace
