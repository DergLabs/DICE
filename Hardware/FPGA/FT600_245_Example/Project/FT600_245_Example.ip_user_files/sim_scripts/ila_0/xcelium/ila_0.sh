...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../FT600_245_Example.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../FT600_245_Example.gen/sources_1/ip/ila_0/hdl/verilog" \
