...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/DICE/dice.runs/input_data_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_data_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_data_fifo.tcl
