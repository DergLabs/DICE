...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/DICE/dice.runs/input_pixel_hold_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log input_pixel_hold_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source input_pixel_hold_ram.tcl
