...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/DICE/dice.runs/output_mem_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_mem_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_mem_ila.tcl
