...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/DICE/dice.runs/output_buffer_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_buffer_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source output_buffer_ram.tcl
