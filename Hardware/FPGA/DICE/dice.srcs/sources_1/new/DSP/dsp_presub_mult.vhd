...
architecture rtl of dsp_presub_mult is
   ...
   signal p       : signed(BWIDTH+CWIDTH downto 0);
...
-- <your_instance_name> : dsp_presub_mult
--  generic map (
