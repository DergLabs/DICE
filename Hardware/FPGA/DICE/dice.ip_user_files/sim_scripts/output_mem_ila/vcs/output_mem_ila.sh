...
#
# Script generated by Vivado on Mon May 26 22:36:29 -0400 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : output_mem_ila.sh
...
#
# Usage        : output_mem_ila.sh
#                output_mem_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_mem_ila.sh [-reset_run]
#                output_mem_ila.sh [-reset_log]
#                output_mem_ila.sh [-help]
#
...
#                script (type 'output_mem_ila.sh -help' for more information).
#
...
# script info
echo -e "output_mem_ila.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_mem_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../dice.gen/sources_1/ip/output_mem_ila/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.output_mem_ila xil_defaultlib.glbl -o output_mem_ila_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./output_mem_ila_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key output_mem_ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc output_mem_ila_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./output_mem_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: output_mem_ila.sh [-help]\n\
Usage: output_mem_ila.sh [-step]\n\
Usage: output_mem_ila.sh [-lib_map_path]\n\
Usage: output_mem_ila.sh [-reset_run]\n\
Usage: output_mem_ila.sh [-reset_log]\n\
Usage: output_mem_ila.sh [-keep_index]\n\
Usage: output_mem_ila.sh [-noclean_files]\n\n\
