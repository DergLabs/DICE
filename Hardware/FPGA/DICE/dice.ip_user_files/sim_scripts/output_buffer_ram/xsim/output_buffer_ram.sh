...
#
# Script generated by Vivado on Mon Feb 17 11:38:36 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : output_buffer_ram.sh
...
#
# Usage        : output_buffer_ram.sh
#                output_buffer_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                output_buffer_ram.sh [-reset_run]
#                output_buffer_ram.sh [-reset_log]
#                output_buffer_ram.sh [-help]
#
...
# script info
echo -e "output_buffer_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./output_buffer_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot output_buffer_ram xil_defaultlib.output_buffer_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim output_buffer_ram -key {Behavioral:sim_1:Functional:output_buffer_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb output_buffer_ram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./output_buffer_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: output_buffer_ram.sh [-help]\n\
Usage: output_buffer_ram.sh [-step]\n\
Usage: output_buffer_ram.sh [-lib_map_path]\n\
Usage: output_buffer_ram.sh [-reset_run]\n\
Usage: output_buffer_ram.sh [-reset_log]\n\
Usage: output_buffer_ram.sh [-keep_index]\n\
Usage: output_buffer_ram.sh [-noclean_files]\n\n\
