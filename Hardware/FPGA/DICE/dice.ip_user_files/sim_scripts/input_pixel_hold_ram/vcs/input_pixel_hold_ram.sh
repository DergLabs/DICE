...
#
# Script generated by Vivado on Thu Feb 27 16:03:17 EST 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : input_pixel_hold_ram.sh
...
#
# Usage        : input_pixel_hold_ram.sh
#                input_pixel_hold_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_pixel_hold_ram.sh [-reset_run]
#                input_pixel_hold_ram.sh [-reset_log]
#                input_pixel_hold_ram.sh [-help]
#
...
#                script (type 'input_pixel_hold_ram.sh -help' for more information).
#
...
# script info
echo -e "input_pixel_hold_ram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_pixel_hold_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.input_pixel_hold_ram xil_defaultlib.glbl -o input_pixel_hold_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./input_pixel_hold_ram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/john/Desktop/DICE/Hardware/FPGA/DICE/dice.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key input_pixel_hold_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc input_pixel_hold_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./input_pixel_hold_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: input_pixel_hold_ram.sh [-help]\n\
Usage: input_pixel_hold_ram.sh [-step]\n\
Usage: input_pixel_hold_ram.sh [-lib_map_path]\n\
Usage: input_pixel_hold_ram.sh [-reset_run]\n\
Usage: input_pixel_hold_ram.sh [-reset_log]\n\
Usage: input_pixel_hold_ram.sh [-keep_index]\n\
Usage: input_pixel_hold_ram.sh [-noclean_files]\n\n\
