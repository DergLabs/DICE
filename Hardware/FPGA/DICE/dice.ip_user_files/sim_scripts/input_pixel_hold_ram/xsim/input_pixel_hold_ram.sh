...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_pixel_hold_ram xil_defaultlib.input_pixel_hold_ram xil_defaultlib.glbl -log elaborate.log
}
