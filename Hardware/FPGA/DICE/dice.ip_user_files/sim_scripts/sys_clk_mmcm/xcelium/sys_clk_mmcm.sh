...
#
# Script generated by Vivado on Fri Jun 06 13:03:24 -0400 2025
...
#
# Usage        : sys_clk_mmcm.sh
#                sys_clk_mmcm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sys_clk_mmcm.sh [-reset_run]
#                sys_clk_mmcm.sh [-reset_log]
#                sys_clk_mmcm.sh [-help]
#
...
#                script (type 'sys_clk_mmcm.sh -help' for more information).
#
...
# script info
echo -e "sys_clk_mmcm.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sys_clk_mmcm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sys_clk_mmcm xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sys_clk_mmcm -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sys_clk_mmcm_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: sys_clk_mmcm.sh [-step]\n\
Usage: sys_clk_mmcm.sh [-lib_map_path]\n\
Usage: sys_clk_mmcm.sh [-reset_run]\n\
Usage: sys_clk_mmcm.sh [-reset_log]\n\
Usage: sys_clk_mmcm.sh [-keep_index]\n\
