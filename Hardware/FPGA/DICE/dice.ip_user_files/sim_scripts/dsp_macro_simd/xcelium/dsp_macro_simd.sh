...
#
# Script generated by Vivado on Mon Feb 10 18:58:48 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_macro_simd.sh
...
#
# Usage        : dsp_macro_simd.sh
#                dsp_macro_simd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_macro_simd.sh [-reset_run]
#                dsp_macro_simd.sh [-reset_log]
#                dsp_macro_simd.sh [-help]
#
...
#                script (type 'dsp_macro_simd.sh -help' for more information).
#
...
# script info
echo -e "dsp_macro_simd.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_macro_simd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_macro_simd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_macro_simd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_macro_simd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_macro_simd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_macro_simd.sh [-help]\n\
Usage: dsp_macro_simd.sh [-step]\n\
Usage: dsp_macro_simd.sh [-lib_map_path]\n\
Usage: dsp_macro_simd.sh [-reset_run]\n\
Usage: dsp_macro_simd.sh [-reset_log]\n\
Usage: dsp_macro_simd.sh [-keep_index]\n\
Usage: dsp_macro_simd.sh [-noclean_files]\n\n\
