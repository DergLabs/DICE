...
#
# Script generated by Vivado on Mon Feb 10 18:56:26 -0500 2025
...
#
# Usage        : dsp_mac.sh
#                dsp_mac.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_mac.sh [-reset_run]
#                dsp_mac.sh [-reset_log]
#                dsp_mac.sh [-help]
#
...
#                script (type 'dsp_mac.sh -help' for more information).
#
...
# script info
echo -e "dsp_mac.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_mac.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_mac xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_mac -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_mac_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: dsp_mac.sh [-step]\n\
Usage: dsp_mac.sh [-lib_map_path]\n\
Usage: dsp_mac.sh [-reset_run]\n\
Usage: dsp_mac.sh [-reset_log]\n\
Usage: dsp_mac.sh [-keep_index]\n\
