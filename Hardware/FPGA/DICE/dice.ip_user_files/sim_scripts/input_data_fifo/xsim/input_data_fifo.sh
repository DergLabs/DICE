...
#
# Script generated by Vivado on Mon Mar 10 10:10:56 -0400 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : input_data_fifo.sh
...
#
# Usage        : input_data_fifo.sh
#                input_data_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_data_fifo.sh [-reset_run]
#                input_data_fifo.sh [-reset_log]
#                input_data_fifo.sh [-help]
#
...
# script info
echo -e "input_data_fifo.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_data_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_data_fifo xil_defaultlib.input_data_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim input_data_fifo -key {Behavioral:sim_1:Functional:input_data_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb input_data_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./input_data_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: input_data_fifo.sh [-help]\n\
Usage: input_data_fifo.sh [-step]\n\
Usage: input_data_fifo.sh [-lib_map_path]\n\
Usage: input_data_fifo.sh [-reset_run]\n\
Usage: input_data_fifo.sh [-reset_log]\n\
Usage: input_data_fifo.sh [-keep_index]\n\
Usage: input_data_fifo.sh [-noclean_files]\n\n\
