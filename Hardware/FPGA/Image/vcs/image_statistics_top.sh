...
design_libs=(xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 axi_utils_v2_0_7 cordic_v6_0_20 xil_defaultlib dsp_macro_v1_0_4)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.image_statistics_top -o image_statistics_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./image_statistics_top_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key image_statistics_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc image_statistics_top_simv.daidir vcs_lib c.obj)
