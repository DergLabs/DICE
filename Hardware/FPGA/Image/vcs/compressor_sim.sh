...
#
# Script generated by Vivado on Thu Jan 23 13:09:40 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : compressor_sim.sh
...
#
# Usage        : compressor_sim.sh
#                compressor_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                compressor_sim.sh [-reset_run]
#                compressor_sim.sh [-reset_log]
#                compressor_sim.sh [-help]
#
...
#                script (type 'compressor_sim.sh -help' for more information).
#
...
# script info
echo -e "compressor_sim.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./compressor_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.compressor_sim -o compressor_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./compressor_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key compressor_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc compressor_sim_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./compressor_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: compressor_sim.sh [-help]\n\
Usage: compressor_sim.sh [-step]\n\
Usage: compressor_sim.sh [-lib_map_path]\n\
Usage: compressor_sim.sh [-reset_run]\n\
Usage: compressor_sim.sh [-reset_log]\n\
Usage: compressor_sim.sh [-keep_index]\n\
Usage: compressor_sim.sh [-noclean_files]\n\n\
