...
#
# Generated by export_simulation on Wed Apr 03 18:37:13 -0400 2024
#
################################################################################
...
'-reset_run' switch to the './ila_ddr2_axi.sh' script.

./ila_ddr2_axi.sh -reset_run
...
./ila_ddr2_axi.sh -noclean_files

For more information on the script, please type './ila_ddr2_axi.sh -help'.
