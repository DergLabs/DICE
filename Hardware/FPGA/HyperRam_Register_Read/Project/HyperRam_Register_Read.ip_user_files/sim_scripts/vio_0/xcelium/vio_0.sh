...
compile()
{
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../HyperRam_Register_Read.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../HyperRam_Register_Read.gen/sources_1/ip/vio_0/hdl" \
