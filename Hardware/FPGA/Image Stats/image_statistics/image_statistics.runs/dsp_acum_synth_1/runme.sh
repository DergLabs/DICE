...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/Image Stats/image_statistics/image_statistics.runs/dsp_acum_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_acum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_acum.tcl
