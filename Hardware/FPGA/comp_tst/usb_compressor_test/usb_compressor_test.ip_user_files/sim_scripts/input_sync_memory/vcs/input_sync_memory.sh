...
#
# Script generated by Vivado on Thu Feb 06 22:38:11 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : input_sync_memory.sh
...
#
# Usage        : input_sync_memory.sh
#                input_sync_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_sync_memory.sh [-reset_run]
#                input_sync_memory.sh [-reset_log]
#                input_sync_memory.sh [-help]
#
...
#                script (type 'input_sync_memory.sh -help' for more information).
#
...
# script info
echo -e "input_sync_memory.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_sync_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.input_sync_memory xil_defaultlib.glbl -o input_sync_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./input_sync_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key input_sync_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc input_sync_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./input_sync_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: input_sync_memory.sh [-help]\n\
Usage: input_sync_memory.sh [-step]\n\
Usage: input_sync_memory.sh [-lib_map_path]\n\
Usage: input_sync_memory.sh [-reset_run]\n\
Usage: input_sync_memory.sh [-reset_log]\n\
Usage: input_sync_memory.sh [-keep_index]\n\
Usage: input_sync_memory.sh [-noclean_files]\n\n\
