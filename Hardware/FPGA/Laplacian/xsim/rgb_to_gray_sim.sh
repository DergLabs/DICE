...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_5 -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L dsp_macro_v1_0_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot rgb_to_gray_sim xil_defaultlib.rgb_to_gray_sim xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rgb_to_gray_sim -key {Behavioral:sim_1:Functional:rgb_to_gray_sim} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xbip_dsp48_wrapper_v3_0_5 xbip_utils_v3_0_11 xbip_pipe_v3_0_7 dsp_macro_v1_0_4)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb rgb_to_gray_sim.wdb xsim.dir libdpi.so)
