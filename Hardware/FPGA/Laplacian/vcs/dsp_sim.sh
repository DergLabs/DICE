...
#
# Script generated by Vivado on Fri Jan 10 15:36:05 -0500 2025
...
#
# Usage        : dsp_sim.sh
#                dsp_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_sim.sh [-reset_run]
#                dsp_sim.sh [-reset_log]
#                dsp_sim.sh [-help]
#
...
#                script (type 'dsp_sim.sh -help' for more information).
#
...
# script info
echo -e "dsp_sim.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_sim -o dsp_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dsp_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_sim_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_sim.sh [-help]\n\
Usage: dsp_sim.sh [-step]\n\
Usage: dsp_sim.sh [-lib_map_path]\n\
Usage: dsp_sim.sh [-reset_run]\n\
Usage: dsp_sim.sh [-reset_log]\n\
Usage: dsp_sim.sh [-keep_index]\n\
Usage: dsp_sim.sh [-noclean_files]\n\n\
