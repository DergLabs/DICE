...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/Image Stats/image_statistics/image_statistics.runs/dsp_macro_simd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_macro_simd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_macro_simd.tcl
