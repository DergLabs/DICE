...
#
# Script generated by Vivado on Tue Jan 07 20:09:59 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : rgb_to_gray_sim.sh
...
#
# Usage        : rgb_to_gray_sim.sh
#                rgb_to_gray_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rgb_to_gray_sim.sh [-reset_run]
#                rgb_to_gray_sim.sh [-reset_log]
#                rgb_to_gray_sim.sh [-help]
#
...
#                script (type 'rgb_to_gray_sim.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_utils_v3_0_11 -libname xbip_pipe_v3_0_7 -libname dsp_macro_v1_0_4 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"
...
# script info
echo -e "rgb_to_gray_sim.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rgb_to_gray_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  "../../Laplacian Core/laplacian_core/laplacian_core.gen/sources_1/ip/dsp_macro_0/sim/dsp_macro_0.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rgb_to_gray_sim xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rgb_to_gray_sim -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rgb_to_gray_sim_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rgb_to_gray_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rgb_to_gray_sim.sh [-help]\n\
Usage: rgb_to_gray_sim.sh [-step]\n\
Usage: rgb_to_gray_sim.sh [-lib_map_path]\n\
Usage: rgb_to_gray_sim.sh [-reset_run]\n\
Usage: rgb_to_gray_sim.sh [-reset_log]\n\
Usage: rgb_to_gray_sim.sh [-keep_index]\n\
Usage: rgb_to_gray_sim.sh [-noclean_files]\n\n\
