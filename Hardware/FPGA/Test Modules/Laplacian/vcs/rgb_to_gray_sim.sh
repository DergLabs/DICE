...
compile()
{
  ...
  "../ Core/laplacian_core/laplacian_core.srcs/sim_1/new/rgb_to_gray_sim.v" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rgb_to_gray_sim xil_defaultlib.glbl -o rgb_to_gray_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rgb_to_gray_sim_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rgb_to_gray_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rgb_to_gray_sim_simv.daidir vcs_lib c.obj)
