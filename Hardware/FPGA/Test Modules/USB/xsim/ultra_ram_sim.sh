...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot ultra_ram_sim xil_defaultlib.ultra_ram_sim -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ultra_ram_sim -key {Behavioral:sim_1:Functional:ultra_ram_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ultra_ram_sim.wdb xsim.dir libdpi.so)
