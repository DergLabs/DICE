...
#
# Script generated by Vivado on Thu Jan 30 18:49:09 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_send_recieve.sh
...
#
# Usage        : tb_send_recieve.sh
#                tb_send_recieve.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_send_recieve.sh [-reset_run]
#                tb_send_recieve.sh [-reset_log]
#                tb_send_recieve.sh [-help]
#
...
#                script (type 'tb_send_recieve.sh -help' for more information).
#
...
# script info
echo -e "tb_send_recieve.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_send_recieve.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src" +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src" +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.gen/sources_1/ip/clk_wiz_0" \
  "../ Compressor/ Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src/send_recieve_module.sv" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src" +incdir+"../../USB\\ Compressor\\ Test/usb_compressor_test/usb_compressor_test.gen/sources_1/ip/clk_wiz_0" \
  "../ Compressor/ Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src/tb_send_recieve.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tb_send_recieve xil_defaultlib.glbl -o tb_send_recieve_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tb_send_recieve_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tb_send_recieve_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tb_send_recieve_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_send_recieve.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_send_recieve.sh [-help]\n\
Usage: tb_send_recieve.sh [-step]\n\
Usage: tb_send_recieve.sh [-lib_map_path]\n\
Usage: tb_send_recieve.sh [-reset_run]\n\
Usage: tb_send_recieve.sh [-reset_log]\n\
Usage: tb_send_recieve.sh [-keep_index]\n\
Usage: tb_send_recieve.sh [-noclean_files]\n\n\
