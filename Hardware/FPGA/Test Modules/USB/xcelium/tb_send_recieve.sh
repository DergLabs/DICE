...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../USB Compressor Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src" +incdir+"../../USB Compressor Test/usb_compressor_test/usb_compressor_test.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../USB Compressor Test/usb_compressor_test/usb_compressor_test.srcs/sources_1/imports/src" +incdir+"../../USB Compressor Test/usb_compressor_test/usb_compressor_test.gen/sources_1/ip/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tb_send_recieve xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tb_send_recieve -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tb_send_recieve_sc.so .tmp_log xcelium_lib waves.shm c.obj)
