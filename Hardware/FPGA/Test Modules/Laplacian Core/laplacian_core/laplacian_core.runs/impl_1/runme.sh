...
HD_PWD='C:/Users/johnh/Desktop/DICE/Hardware/FPGA/Laplacian Core/laplacian_core/laplacian_core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lpc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lpc_top.tcl -notrace
