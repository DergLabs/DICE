...
#
# Script generated by Vivado on Mon Jan 13 18:08:47 -0500 2025
...
design_libs_elab="-libname xil_defaultlib -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_utils_v3_0_11 -libname xbip_pipe_v3_0_7 -libname dsp_macro_v1_0_4 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname axi_utils_v2_0_7 -libname cordic_v6_0_20 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xbip_dsp48_wrapper_v3_0_5 xbip_utils_v3_0_11 xbip_pipe_v3_0_7 dsp_macro_v1_0_4 c_reg_fd_v12_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 axi_utils_v2_0_7 cordic_v6_0_20)
...
compile()
{
  ...
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_dsp48_wrapper_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_utils_v3_0_11 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_utils_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_pipe_v3_0_7 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_pipe_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work dsp_macro_v1_0_4 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/dsp_macro_v1_0_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null
  ...
  "../../Laplacian Core/laplacian_core/laplacian_core.gen/sources_1/ip/dsp_macro_simd/sim/dsp_macro_simd.vhd" \
  ...
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/c_reg_fd_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_dsp48_addsub_v3_0_7 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_dsp48_addsub_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_addsub_v3_0_7 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_addsub_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work c_addsub_v12_0_16 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/c_addsub_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_bram18k_v3_0_7 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/xbip_bram18k_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work mult_gen_v12_0_19 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/mult_gen_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work axi_utils_v2_0_7 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/axi_utils_v2_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work cordic_v6_0_20 $xmvhdl_opts \
  "../../Image Stats/image_statistics/image_statistics.ip_user_files/ipstatic/hdl/cordic_v6_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xil_defaultlib $xmvhdl_opts \
  "../../Gradient Core/gradient_core/gradient_core.gen/sources_1/ip/sqrt_cordic/sim/sqrt_cordic.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/rgb_to_gray_sim.v" \
  2>&1 | tee -a compile.log; cat .tmp_log > xmvlog.log 2>/dev/null

  xmvhdl -work xil_defaultlib $xmvhdl_opts \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sources_1/new/rgb_to_grayscale.vhd" \
  "../../Gradient Core/gradient_core/gradient_core.srcs/sources_1/imports/new/data_delay_reg.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sources_1/new/laplacian_core.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sources_1/new/variance_core.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sources_1/new/lpc_top.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/blur_sim.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sources_1/new/dsp.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/dsp_sim.vhd" \
  ...
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/laplacian_sim.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/rgb2gray_sim.vhd" \
  "../../Laplacian Core/laplacian_core/laplacian_core.srcs/sim_1/new/shift_reg_sim.vhd" \
  "../../Gradient Core/gradient_core/gradient_core.srcs/sources_1/new/statistics_core.vhd" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/johnh/Desktop/DICE/Hardware/FPGA/Image"
  fi
