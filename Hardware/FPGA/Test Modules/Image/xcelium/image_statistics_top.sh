...
#
# Script generated by Vivado on Thu Jan 23 16:39:10 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : image_statistics_top.sh
...
#
# Usage        : image_statistics_top.sh
#                image_statistics_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                image_statistics_top.sh [-reset_run]
#                image_statistics_top.sh [-reset_log]
#                image_statistics_top.sh [-help]
#
...
#                script (type 'image_statistics_top.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname axi_utils_v2_0_7 -libname cordic_v6_0_20 -libname xil_defaultlib -libname dsp_macro_v1_0_4 -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 axi_utils_v2_0_7 cordic_v6_0_20 xil_defaultlib dsp_macro_v1_0_4)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "image_statistics_top.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./image_statistics_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.image_statistics_top
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.image_statistics_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log image_statistics_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./image_statistics_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: image_statistics_top.sh [-help]\n\
Usage: image_statistics_top.sh [-step]\n\
Usage: image_statistics_top.sh [-lib_map_path]\n\
Usage: image_statistics_top.sh [-reset_run]\n\
Usage: image_statistics_top.sh [-reset_log]\n\
Usage: image_statistics_top.sh [-keep_index]\n\
Usage: image_statistics_top.sh [-noclean_files]\n\n\
