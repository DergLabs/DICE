...
#
# Script generated by Vivado on Thu Jan 23 15:50:01 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : variance_sim.sh
...
#
# Usage        : variance_sim.sh
#                variance_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                variance_sim.sh [-reset_run]
#                variance_sim.sh [-reset_log]
#                variance_sim.sh [-help]
#
...
#                script (type 'variance_sim.sh -help' for more information).
#
...
# script info
echo -e "variance_sim.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./variance_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.variance_sim
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.variance_sim -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log variance_sim_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./variance_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: variance_sim.sh [-help]\n\
Usage: variance_sim.sh [-step]\n\
Usage: variance_sim.sh [-lib_map_path]\n\
Usage: variance_sim.sh [-reset_run]\n\
Usage: variance_sim.sh [-reset_log]\n\
Usage: variance_sim.sh [-keep_index]\n\
Usage: variance_sim.sh [-noclean_files]\n\n\
