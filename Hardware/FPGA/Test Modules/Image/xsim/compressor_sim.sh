...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot compressor_sim xil_defaultlib.compressor_sim -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim compressor_sim -key {Behavioral:sim_1:Functional:compressor_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb compressor_sim.wdb xsim.dir libdpi.so)
