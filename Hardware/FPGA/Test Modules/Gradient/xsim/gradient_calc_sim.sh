...
#
# Script generated by Vivado on Mon Jan 13 17:08:37 -0500 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gradient_calc_sim.sh
...
#
# Usage        : gradient_calc_sim.sh
#                gradient_calc_sim.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gradient_calc_sim.sh [-reset_run]
#                gradient_calc_sim.sh [-reset_log]
#                gradient_calc_sim.sh [-help]
#
...
# script info
echo -e "gradient_calc_sim.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gradient_calc_sim.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_5 -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L dsp_macro_v1_0_4 -L xil_defaultlib -L secureip --snapshot gradient_calc_sim xil_defaultlib.gradient_calc_sim -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gradient_calc_sim -key {Behavioral:sim_1:Functional:gradient_calc_sim} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gradient_calc_sim.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gradient_calc_sim.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gradient_calc_sim.sh [-help]\n\
Usage: gradient_calc_sim.sh [-step]\n\
Usage: gradient_calc_sim.sh [-lib_map_path]\n\
Usage: gradient_calc_sim.sh [-reset_run]\n\
Usage: gradient_calc_sim.sh [-reset_log]\n\
Usage: gradient_calc_sim.sh [-keep_index]\n\
Usage: gradient_calc_sim.sh [-noclean_files]\n\n\
