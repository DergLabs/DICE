...
HD_PWD='C:/Users/micha/OneDrive/Desktop/DICE/Hardware/FPGA/ODDR_Test/Project/ODDR_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oddr_test_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oddr_test_top.tcl -notrace
