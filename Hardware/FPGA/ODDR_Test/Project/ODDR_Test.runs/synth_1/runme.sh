...
HD_PWD='C:/Users/micha/OneDrive/Desktop/DICE/Hardware/FPGA/ODDR_Test/Project/ODDR_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oddr_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oddr_test_top.tcl
